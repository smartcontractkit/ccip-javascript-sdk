...
export class InvalidInputsTokenIndices extends Error {
  ...
  constructor(readonly logs?: string[]) {
    super('7007: Invalid pool account indices')
  }
}
...
export class InvalidCcipVersionRollback extends Error {
  ...
  constructor(readonly logs?: string[]) {
    super('7025: Invalid rollback attempt on the CCIP version of the onramp to the destination chain')
  }
}
export class InvalidAccountListForPdaDerivation extends Error {
  ...
  constructor(readonly logs?: string[]) {
    super('7026: Invalid account list for PDA derivation')
  }
}
export class InvalidDerivationStage extends Error {
  ...
  constructor(readonly logs?: string[]) {
    super('7027: Unexpected account derivation stage')
  }
}
export class InvalidNonceVersion extends Error {
  ...
  constructor(readonly logs?: string[]) {
    super('7028: Invalid version of the Nonce account')
  }
}
export class InvalidTokenPoolAccountDerivationResponse extends Error {
  ...
  constructor(readonly logs?: string[]) {
    super('7029: Token pool returned an unexpected derivation response')
  }
}
export class AccountDerivationResponseTooLarge extends Error {
  ...
  constructor(readonly logs?: string[]) {
    super("7030: Can't fit account derivation response")
  }
}
export class DefaultOwnerProposal extends Error {
  ...
  constructor(readonly logs?: string[]) {
    super('7031: Proposed owner is the default pubkey')
  }
}
...
export function fromCode(code: number, logs?: string[]): CustomError | null {
  switch (code) {
    ...
    case 7026:
      return new InvalidAccountListForPdaDerivation(logs)
    case 7027:
      return new InvalidDerivationStage(logs)
    case 7028:
      return new InvalidNonceVersion(logs)
    case 7029:
      return new InvalidTokenPoolAccountDerivationResponse(logs)
    case 7030:
      return new AccountDerivationResponseTooLarge(logs)
    case 7031:
      return new DefaultOwnerProposal(logs)
  }
  return null
}
